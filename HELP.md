...
* The original package name 'com.nagarro.java.mini.assignment-2' is invalid and this project uses 'com.nagarro.java.mini.assignment2' instead.
...
* [Spring Web Services](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/index.html#io.webservices)
